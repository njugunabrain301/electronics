...
function Opulence({ closeModal }) {
  ...
  return (
    <div className="w-full h-screen flex justify-center items-center">
      <Card
        className="w-[330px] rounded-md pt-0 "
        style={{
      ...
      >
        <CardHeader
          variant="gradient"
          className="mb-4 grid h-28 place-items-center w-full m-0"
          style={{
        ...
        <form className="p-4 mt-4 mb-2 w-full">
