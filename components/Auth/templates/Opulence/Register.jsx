...
function Register({ closeModal, toggleLogin, selectedTheme }) {
  ...
  return (
    ...
    >
      <CardHeader
        variant="gradient"
        className="mb-4 grid h-28 place-items-center m-0 w-full"
        style={{
      ...
      <form className="p-[20px] mt-4 mb-2 w-120 sm:w-80">
        ...
        >
          ...
          <span className="text-end text-sm font-normal flex items-center">
