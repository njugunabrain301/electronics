...
function PrivacyPolicy({ profile }) {
  ...
  console.log(theme);
  return (
    <div className="w-[90%] mx-auto my-3 myPolicy">
      <div data-custom-class="body" style={{ color: theme.palette.text.base }}>
        <div>
          <strong>
            ...
            <strong>
              <span style={{ fontSize: "15px" }}>
                <span data-custom-class="subtitle">
                  Last updated{" "}
                  <span className="question">February 16, 2024</span>
                </span>
              </span>
            </strong>
          </span>
          ...
          <span style={{}}>
            <span style={{ fontSize: "15px" }}>
              <span data-custom-class="body_text">
                ...
                <span className="question">{profile.name}</span> (
            ...
            <span style={{ fontSize: "15px" }}>
              <span style={{ fontSize: "15px" }}>
                <span data-custom-class="body_text">
                  ...
                  <span className="question">{profile.url}</span>
                  <span style={{ fontSize: "15px" }}>
                    <span style={{}}>
                      <span data-custom-class="body_text">
                        <span style={{ fontSize: "15px" }}>
        ...
        <div>
          ...
          <div style={{ lineHeight: "1.5" }}>
            <span style={{ fontSize: "15px" }}>
              <span style={{ oldColor: "rgb(127, 127, 127)" }}>
                <span data-custom-class="body_text">
                  <span style={{ oldColor: "rgb(89, 89, 89)" }}>
                    <span data-custom-class="body_text">
                      <span className="block-component" />
          ...
          <ul>
            <li style={{ lineHeight: "1.5" }}>
              <span style={{ fontSize: "15px", oldColor: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: "15px", oldColor: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
            ...
            <span style={{ fontSize: "15px" }}>
              <span style={{ oldColor: "rgb(127, 127, 127)" }}>
                <span data-custom-class="body_text">
                  ...
                  <span className="question">{profile.url + "/contacts"}</span>.
                </span>
              </span>
            </span>
          </div>
          ...
          <div style={{ lineHeight: "1.5" }}>
            <span style={{ fontSize: "15px" }}>
              <span data-custom-class="body_text">
                ...
                unauthorized
                <span className="statement-end-if-in-editor" /> third parties
          ...
          <div style={{ lineHeight: "1.5" }}>
            <a data-custom-class="link" href="#contact">
              <span style={{ oldColor: "rgb(89, 89, 89)", fontSize: "15px" }}>
          ...
          <div id="infocollect" style={{ lineHeight: "1.5" }}>
            <span style={{ oldColor: "rgb(127, 127, 127)" }}>
              <span style={{ oldColor: "rgb(89, 89, 89)", fontSize: "15px" }}>
                <span style={{ fontSize: "15px", oldColor: "rgb(89, 89, 89)" }}>
                  <span
                    style={{ fontSize: "15px", oldColor: "rgb(89, 89, 89)" }}
                  >
                    <span id="control" style={{ oldColor: "rgb(0, 0, 0)" }}>
                      <strong>
            ...
            <span style={{ fontSize: "15px", oldColor: "rgb(89, 89, 89)" }}>
              <span style={{ fontSize: "15px", oldColor: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  called <span className="block-component" />"
                  <span className="statement-end-if-in-editor" />
                  <span style={{ fontSize: "15px" }}>
                    <span data-custom-class="body_text">
                      <span style={{ fontSize: "15px" }}>
              ...
              <span style={{ fontSize: "15px", oldColor: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: "15px", oldColor: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
                    ...
                    Services<span style={{ fontSize: "15px" }}>&nbsp;</span>
          ...
          <div style={{ lineHeight: "1.5" }}>
            ...
            <div style={{ lineHeight: "1.5" }}>
              ...
              <div>
                ...
                <span data-custom-class="body_text">
                  <span
                    style={{ oldColor: "rgb(89, 89, 89)", fontSize: "15px" }}
                  >
                    <span data-custom-class="body_text">
                      <span
                        style={{
                                      ...
                                      <li style={{ lineHeight: "1.5" }}>
                                        <span style={{ fontSize: "15px" }}>
                                          <span data-custom-class="body_text">
                                            ...
                                            certain Google Maps Platform APIs
                                            (e.g.
                                            <span className="block-component" />
                                            ,
                                            <span className="statement-end-if-in-editor" />{" "}
                                          ...
                                          >
                                            ...
                                            >
                                              <span data-custom-class="body_text">
                                                ...
                                                will be effective as soon as it
